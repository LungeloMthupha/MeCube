...
<head>
    ...
    <link rel="stylesheet" href="css/notice-card.css">
    <link rel="stylesheet" href="css/client-noticeboard.css">
        ...
        <div class="bottom">
            <div class="sidenav">
                ...
                <div class="links">
                    ...
                    <a href="client-noticeboard.php" class="init">
            ...
            <div class="content">
                ...
                <?php while($notice = mysqli_fetch_assoc($result)){ ?>
                    <div class="card">
                        <div class="card-image"><img src="img/back.jpg" alt=""></div>
                        <div class="category"> Notice </div>
                        <div class="heading"> <?php echo $notice['header']; ?> 
                            <div class="author"> By <span class="name"> <?php echo $notice['username']; ?> </span>  <?php echo $notice['regdate']; ?> </div>
                        </div>
                    </div>
                    <?php } ?>
                </div>
