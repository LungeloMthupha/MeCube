...
<head>
    ...
    <link rel="stylesheet" href="css/client-equipment.css">
        ...
        <div class="bottom">
            <div class="sidenav">
                ...
                <div class="links">
                    ...
                    <a href="client-equipment.php" class="init">
            ...
            <div class="content">
                ...
                <?php while($equipment = mysqli_fetch_assoc($result)){ ?>
                    <div class="card">
                        <div class="card-image"><img src="img/pngegg (16).png" alt=""></div>
                        <div class="category"> <?php echo $equipment['brand']; ?> </div>
                        <div class="heading"> <?php echo $equipment['name']; ?>
                            <div class="author"><?php echo $equipment['regdate']; ?></div>
                        </div>
                    </div>
                    <?php } ?>
                </div>
