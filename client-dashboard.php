...
<?php
 ...
 //READ member data
 $sql = "SELECT * FROM noticeboard ORDER BY id LIMIT 3";
 $result = mysqli_query($conn, $sql);

 $sqlx = "SELECT * FROM product ORDER BY id LIMIT 5";
...
<head>
    ...
    <link rel="stylesheet" href="css/product-card-mini.css">
    ...
    <main>
        ...
        <div class="bottom">
            <div class="sidenav">
                <h3>Menu</h3>
                <div class="links">
                    <a href="client-dashboard.php" class="init">
            ...
            <div class="content">
                ...
                <div class="down-half">
                    <div class="graph gr3">
                        <h3>On the Noticeboard</h3>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Harum illum alias possimus quisquam placeat doloribus,</p>
                        <div class="product-store">
                            <?php while($notice = mysqli_fetch_assoc($result)){ ?>
                                <div class="card">
                                <div class="img"><img src="img/icons/icons8_sms_24px.png" alt=""></div>
                                <div class="textBox">
                                    <div class="textContent">
                                        <p class="h1"><?php echo $notice['header']; ?></p>
                                        <span class="span"><?php echo $notice['regdate']; ?></span>
                                    </div>
                                    <p class="p">Please visit the notice page to see notice</p>
                                    <div>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                            ...
                            <div class="seeall">
                                <a href="noticeboard.php">View All</a>
                            </div>
                        </div>
                    ...
                    <div class="graph gr4">
                        ...
                        <div class="new-list">
                            <table>
                                ...
                                <tbody>
                                <?php while($product = mysqli_fetch_assoc($resultx)){ ?>
                                    <tr>
                            ...
                            <div class="seeall">
                                <a href="client-store.php">View All</a>
                            </div>
                        </div>
                    </div>
                </div>
