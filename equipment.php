...
if(isset($_POST['submit'])){
    ...
    $brand = $_POST['brand'];
    $image = $_POST['image'];
    $sql = "INSERT INTO `equipment`(`name`, `brand`, `image`) VALUES ('$name', '$brand', '$image')";
...
if(isset($_POST['update'])){
    ...
    $brand = $_POST['brand'];
    $image = $_POST['image'];
    $sql = "UPDATE equipment SET name='$name', brand='$brand', image='$image' WHERE id='$id'";
    mysqli_query($conn, $sql);
...
<body>
        ...
        <div class="bottom">
            <div class="sidenav">
                ...
                <div class="links">
                    ...
                    <a href="equipment.php" class="init">
                ...
                <div class="displayData">
                    <table class="member display" id="member" style="width:100%">
                        ...
                        <?php while($equipment = mysqli_fetch_assoc($result)){ ?>
                                ...
                                <td><?php echo $equipment['regdate']; ?></td>
                                <td>
                                    <div class="action">
                                    <a href="?edit=<?php echo $equipment['id']; ?>" class="edit"><img src="img/icons/icons8_edit_24px_1.png" alt=""></a>
                                <a href="?delete=<?php echo $equipment['id']; ?>" class="delete"><img src="img/icons/icons8_trash_24px_1.png" alt=""></a>
                                    </div>
    ...
    <div class="crud" id="crud">
        ...
        <?php if (isset($_GET['edit'])){
            ...
            $sql1 = "SELECT `id`, `name`, `brand`, `image`, `regdate` FROM `equipment` WHERE `id` = $clicked_id";
            $result1 = mysqli_query($conn, $sql1);
            $equipment1 = mysqli_fetch_assoc($result1);
            }
            ?>
            <h3>Add / Edit</h3>
            <div class="group">
            ...
            <div class="group">
                <div class="part">
                    <p>Name</p>
                    <input type="text"  name="name" value="<?php echo isset($_GET['edit']) && isset($equipment1['name']) ? $equipment1['name'] : ''; ?>">
                </div>
                <div class="part">
                    <p>Brand</p>
                    <input type="text"  name="brand" value="<?php echo isset($_GET['edit']) && isset($equipment1['brand']) ? $equipment1['brand'] : ''; ?>">
                </div>
                <div class="part">
                    <p>Equipment Image</p>
                    <input type="text" class="long"  name="image" value="<?php echo isset($_GET['edit']) && isset($equipment1['image']) ? $equipment1['image'] : ''; ?>">
                </div>
            </div>
            <div class="group">
